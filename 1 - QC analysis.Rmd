...
ggsave("Figures/FigS1_LFQ_distributions.pdf", plot = LFQ_dist, device = "pdf", width = 8.5, height = 11, units = "in", dpi = 300)
...
pdf(file="Figures/FigS2.pdf", width = 4.25, height = 20)
...
pdf(file="Figures/Fig2D.pdf", width = 4.25, height = 20)
...
write_csv(ANOVA_results, "Supp tables/S2_ANOVA_results.csv")
```
...
pdf(file="Figures/Fig2C_upset.pdf", width = 8.5, height = 6)
...
ggsave("Figures/FigS3A_PCA12_facet.pdf", plot = facet_1_2, device = "pdf", width = 10, height = 5.75, units = "in", dpi = 300)
...
ggsave("Figures/FigS3B_PCA23_facet.pdf", plot = facet_2_3, device = "pdf", width = 10, height = 5.75, units = "in", dpi = 300)
